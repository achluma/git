...
int cmd_main(int argc, const char **argv) {
	...
	TEST(check_show_date("format-local:%Y-%m-%d %H:%M:%S", "123456789 +1234", "2016-06-15 09:13:20", "", "EST5"), "Check_show_date - format-local:%%Y-%%m-%%d %%H:%%M:%%S works");
	...
	TEST(check_parse_date("2008-02-14 20:30:45", "2008-02-14 20:30:45 -0500", "ESTS"), "check_parse_date - 2008-02-14 20:30:45 -0500 works");
